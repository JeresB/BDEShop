...
if (isset($_POST) && !empty($_POST)) {
  ...
  if ($update == 1) {
    $success = $gestion_bdd->update($_POST['id'], $_POST['nom'], $_POST['description'], $_POST['vendeur'], $_POST['place_total'], $_POST['place_restante'], $types, $horaires, $codes_promo, $photo, $activation);
  } else {
    $success = $gestion_bdd->add($_POST['nom'], $_POST['description'], $_POST['vendeur'], $_POST['place_total'], $_POST['place_restante'], $types, $horaires, $codes_promo, $photo, $activation);
  }
